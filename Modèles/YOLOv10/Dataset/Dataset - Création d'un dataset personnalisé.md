...
Objectif: Déterminer la marche à suivre pour créer un dataset personnalisé
aliases:
---
# 1. Extraire les images des vidéos

Chaque vidéo enregistrée de la ruche ont une résolution de720p pour 60 fps ([[animals-13-01182.pdf|source]]). Ainsi en ne gardant qu'une frame sur 30, on obtient deux images secondes. Cela nous permet ainsi d'avoir des images avec des position différentes des abeilles. 

Pour ce faire, nous allons utiliser la bibliothèque OpenCV. Voici un exemple de code :
...
Ce code fonctionne très bien. Il génère un dossier qui contient toutes les frame. 
# 2.  Tester YOLOv10 sur les frames
## 2.1 Utiliser un dataset Robotflow 
## 2.2 Utiliser un dataset personnalisé
